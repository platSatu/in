...
<div class="middle-content container-xxl p-0">
    ...
    <div class="widget-content widget-content-area">
        ...
        <form action="{{ route('zoom.meeting.store') }}" method="POST">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('topic') is-invalid @enderror" id="topic" name="topic"
                    placeholder="Contoh: Rapat Koordinasi Mingguan" value="{{ old('topic') }}">
                @error('topic')
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="time" class="form-control @error('start_time_of_day') is-invalid @enderror"
                        id="start_time_of_day" name="start_time_of_day" value="{{ old('start_time_of_day') }}">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <label for="password" class="form-label">Passcode <span class="text-muted">(opsional, dikosongkan = otomatis dari Zoom)</span></label>
                    ...
                    <div class="col-sm-4 mb-2">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="join_before_host"
                                name="join_before_host" value="1" {{ old('join_before_host', $defaultSettings['join_before_host']) ? 'checked' : '' }}>
                    ...
                    <div class="col-sm-4 mb-2">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="waiting_room"
                                name="waiting_room" value="1" {{ old('waiting_room', $defaultSettings['waiting_room']) ? 'checked' : '' }}>
                    ...
                    <div class="col-sm-4 mb-2">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="host_video"
                                name="host_video" value="1" {{ old('host_video', $defaultSettings['host_video']) ? 'checked' : '' }}>
                    ...
                    <div class="col-sm-4 mb-2">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="participant_video"
                                name="participant_video" value="1" {{ old('participant_video', $defaultSettings['participant_video']) ? 'checked' : '' }}>
                    ...
                    <div class="col-sm-4 mb-2">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="mute_upon_entry"
                                name="mute_upon_entry" value="1" {{ old('mute_upon_entry', $defaultSettings['mute_upon_entry']) ? 'checked' : '' }}>
