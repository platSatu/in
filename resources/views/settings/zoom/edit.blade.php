...
<div class="middle-content container-xxl p-0">
    ...
    <form action="{{ route('settings.zoom.update', $data->id) }}" method="POST">
        @csrf
        @method('PUT')
            ...
            <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="widget-content widget-content-area ecommerce-create-section">
                    ...
                    <div class="alert alert-warning">
                        Demi keamanan, kredensial yang sudah tersimpan tidak ditampilkan ulang di sini.
                        Biarkan kosong field yang tidak ingin diubah -- nilai lama akan tetap dipakai.
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control @error('account_id') is-invalid @enderror"
                                ...
                                placeholder="•••••••• (biarkan kosong jika tidak berubah)" autocomplete="off">
                            @error('account_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6">
                            ...
                            <input type="password" class="form-control @error('client_secret') is-invalid @enderror"
                                ...
                                placeholder="•••••••• (biarkan kosong jika tidak berubah)" autocomplete="new-password">
                            @error('client_secret')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-sm-6">
                            <label for="secret_token" class="mb-2">Secret Token</label>
                            <input type="password" class="form-control @error('secret_token') is-invalid @enderror"
                                id="secret_token" name="secret_token" value="{{ old('secret_token') }}"
                                placeholder="•••••••• (biarkan kosong jika tidak berubah)" autocomplete="new-password">
                            @error('secret_token')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
