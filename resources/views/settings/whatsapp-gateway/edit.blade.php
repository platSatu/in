                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                id="name" name="name" placeholder="Contoh: Wablas Utama" value="{{ old('name', $data->name) }}">
                            @error('name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            ...
                            <input type="url" class="form-control @error('api_host') is-invalid @enderror"
                                id="api_host" name="api_host" placeholder="https://smg.wablas.com" value="{{ old('api_host', $data->api_host) }}">
                            <div class="form-text">
