...
<div class="middle-content container-xxl p-0">
    ...
    <form action="{{ route('settings.whatsapp-gateway.update', $data->id) }}" method="POST">
        @csrf
        @method('PUT')
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6">
                            ...
                            <select class="form-select @error('gateway') is-invalid @enderror" id="gateway" name="gateway">
                                @foreach ($gatewayOptions as $value => $label)
                                    <option value="{{ $value }}" {{ old('gateway', $data->gateway) === $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                id="name" name="name" placeholder="Contoh: Gateway Utama" value="{{ old('name', $data->name) }}">
                            @error('name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            ...
                            <input type="url" class="form-control @error('api_host') is-invalid @enderror"
                                id="api_host" name="api_host" placeholder="https://domain-konexa-anda.com" value="{{ old('api_host', $data->api_host) }}">
                            <div class="form-text">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control @error('token') is-invalid @enderror"
                                id="token" name="token" placeholder="Token dari halaman Device Konexa/Teleios" value="{{ old('token', $data->token) }}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control @error('secret_key') is-invalid @enderror"
                                id="secret_key" name="secret_key" placeholder="Secret key dari halaman Device Konexa/Teleios" value="{{ old('secret_key', $data->secret_key) }}">
                            <div class="form-text">
