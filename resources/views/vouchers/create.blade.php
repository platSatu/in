                        ...
                        <div class="col-sm-6">
                            ...
                            <select id="application_category_id" name="application_category_id" class="form-select @error('application_category_id') is-invalid @enderror">
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}" {{ old('application_category_id') === $category->id ? 'selected' : '' }}>
                                        {{ $category->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6">
                            ...
                            <input type="text"
                                   ...
                                   id="code_vouchers" name="code_vouchers" value="{{ old('code_vouchers') }}">
                            @error('code_vouchers')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="widget-content widget-content-area ecommerce-create-section">
                    <div class="row">
                        <div class="col-sm-12 mb-3">
                            <button type="submit" class="btn btn-success w-100">Create Voucher</button>
                        </div>
                        <div class="col-sm-12">
