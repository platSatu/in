...
<div class="middle-content container-xxl p-0">
    ...
    <form action="{{ route('historyuserlogin.update', $data->id) }}" method="POST">
        @csrf
        @method('PUT')
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6">
                            ...
                            <input type="datetime-local"
                                   ...
                                   value="{{ old('last_login', optional($data->last_login)->format('Y-m-d\TH:i')) }}">
                            @error('last_login')
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="datetime-local"
                                   ...
                                   value="{{ old('last_logout', optional($data->last_logout)->format('Y-m-d\TH:i')) }}">
                            @error('last_logout')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('duration', $data->duration) }}" placeholder="Contoh: 2 jam 15 menit">
                            @error('duration')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="widget-content widget-content-area ecommerce-create-section">
                    <div class="row">
                        <div class="col-sm-12 mb-3">
                            <button type="submit" class="btn btn-success w-100">Update History Login</button>
                        </div>
                        <div class="col-sm-12">
