            ...
            <div class="row g-0">
                ...
                <div
                    ...
                    <div class="card rounded-0 mb-0 border-0 shadow-none bg-transparent">
                        <div class="card-body">
                            <img src="{{ asset('authLogin') }}/assets/images/auth/register1.png"
                                ...
                                <form method="POST" action="{{ route('register') }}" class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" id="inputUsername" name="name"
                                            value="{{ old('name') }}" placeholder="Jhon" required autofocus>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="tel" class="form-control" id="handphone" name="handphone"
                                            value="{{ old('handphone') }}" placeholder="6281234567890" maxlength="20"
                                            required>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox"
                                                id="flexSwitchCheckChecked" name="terms" required>
