...
<head>
    ...
    <title>Login | Satora </title>
    <!--favicon-->
    <link rel="icon" href="{{ asset('authLogin') }}/assets/images/favicon-32x32.png" type="image/png">
            ...
            <div class="row g-0">
                ...
                <div
                    ...
                    <div class="card rounded-0 mb-0 border-0 shadow-none bg-transparent">
                        <div class="card-body">
                            <img src="{{ asset('authLogin') }}/assets/images/auth/login1.png"
