...
<div class="middle-content container-xxl p-0">
    ...
    <form action="{{ route('absensi.attendance.update', $data->id) }}" method="POST">
        @csrf
        @method('PUT')
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6">
                            ...
                            <input type="date" class="form-control @error('attendance_date') is-invalid @enderror"
                                ...
                                value="{{ old('attendance_date', $data->attendance_date) }}">
                            ...
                            <select class="form-select @error('attendance_setting_id') is-invalid @enderror"
                                ...
                                @foreach ($settings as $setting)
                                    <option value="{{ $setting->id }}"
                                        {{ old('attendance_setting_id', $data->attendance_setting_id) === $setting->id ? 'selected' : '' }}>
                                        {{ $setting->id }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6">
                            ...
                            <input type="time" class="form-control @error('check_in_time') is-invalid @enderror"
                                ...
                                value="{{ old('check_in_time', $data->check_in_time) }}">
                            @error('check_in_time')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="time" class="form-control @error('check_out_time') is-invalid @enderror"
                                ...
                                value="{{ old('check_out_time', $data->check_out_time) }}">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6">
                            ...
                            <input type="number" min="0"
                                ...
                                name="late_minutes" value="{{ old('late_minutes', $data->late_minutes) }}">
                            @error('late_minutes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="number" step="0.01" min="0"
                                ...
                                name="work_hours" value="{{ old('work_hours', $data->work_hours) }}">
                            @error('work_hours')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-3">
                            ...
                            <input type="text" class="form-control @error('check_in_lat') is-invalid @enderror"
                                id="check_in_lat" name="check_in_lat"
                                value="{{ old('check_in_lat', $data->check_in_lat) }}">
                            @error('check_in_lat')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-sm-3">
                            ...
                            <input type="text" class="form-control @error('check_in_lng') is-invalid @enderror"
                                id="check_in_lng" name="check_in_lng"
                                value="{{ old('check_in_lng', $data->check_in_lng) }}">
                            @error('check_in_lng')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-sm-3">
                            ...
                            <input type="text" class="form-control @error('check_out_lat') is-invalid @enderror"
                                id="check_out_lat" name="check_out_lat"
                                value="{{ old('check_out_lat', $data->check_out_lat) }}">
                            @error('check_out_lat')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-sm-3">
                            ...
                            <input type="text" class="form-control @error('check_out_lng') is-invalid @enderror"
                                id="check_out_lng" name="check_out_lng"
                                value="{{ old('check_out_lng', $data->check_out_lng) }}">
                            @error('check_out_lng')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control @error('check_in_method') is-invalid @enderror"
                                id="check_in_method" name="check_in_method"
                                value="{{ old('check_in_method', $data->check_in_method) }}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control @error('device_info') is-invalid @enderror"
                                id="device_info" name="device_info" value="{{ old('device_info', $data->device_info) }}">
                            @error('device_info')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                                ...
                                <div class="col-xxl-12 mb-4">
                                    ...
                                    <select class="form-select @error('status') is-invalid @enderror" id="status" name="status">
                                        ...
                                        <option value="present"
                                            {{ old('status', $data->status) === 'present' ? 'selected' : '' }}>Present</option>
                                        <option value="late"
                                            {{ old('status', $data->status) === 'late' ? 'selected' : '' }}>Late</option>
                                        <option value="absent"
                                            {{ old('status', $data->status) === 'absent' ? 'selected' : '' }}>Absent</option>
                                        <option value="leave"
                                            {{ old('status', $data->status) === 'leave' ? 'selected' : '' }}>Leave</option>
                                        <option value="sick"
                                            {{ old('status', $data->status) === 'sick' ? 'selected' : '' }}>Sick</option>
                                        <option value="permission"
                                            {{ old('status', $data->status) === 'permission' ? 'selected' : '' }}>Permission</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="widget-content widget-content-area ecommerce-create-section">
                            <div class="row">
                                <div class="col-sm-12 mb-3">
                                    <button type="submit" class="btn btn-success w-100">Update Attendance</button>
                                </div>
                                <div class="col-sm-12">
