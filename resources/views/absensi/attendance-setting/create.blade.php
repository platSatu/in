...
<div class="middle-content container-xxl p-0">
    ...
    <form action="{{ route('absensi.attendance-setting.store') }}" method="POST">
        @csrf
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                name="name" value="{{ old('name') }}" placeholder="Enter attendance setting name...">
                            @error('name')
                        ...
                        <div class="widget-content widget-content-area ecommerce-create-section">
                            <div class="row">
                                <div class="col-sm-12 mb-3">
                                    <button type="submit" class="btn btn-success w-100">Create Setting</button>
                                </div>
                                <div class="col-sm-12">
