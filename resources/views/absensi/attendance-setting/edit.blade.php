...
<div class="middle-content container-xxl p-0">
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('absensi.attendance-setting.index') }}">Attendance Setting</a></li>
                <li class="breadcrumb-item active" aria-current="page">Edit</li>
            </ol>
        </nav>
    </div>

    <form action="{{ route('absensi.attendance-setting.update', $data->id) }}" method="POST">
        @csrf
        @method('PUT')
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                ...
                                placeholder="Enter attendance setting name...">
                            @error('name')
                    ...
                    <div class="col-xxl-12 col-xl-4 col-lg-4 col-md-5 mt-4">
                        <div class="widget-content widget-content-area ecommerce-create-section">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <a href="{{ route('absensi.attendance-setting.index') }}"
