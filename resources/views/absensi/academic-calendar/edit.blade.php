...
<div class="middle-content container-xxl p-0">
    ...
    <form action="{{ route('absensi.academic-calendar.update', $data->id) }}" method="POST">
        @csrf
        @method('PUT')
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6">
                            ...
                            <input type="date" class="form-control @error('start_date') is-invalid @enderror"
                                id="start_date" name="start_date" value="{{ old('start_date', $data->start_date) }}">
                            @error('start_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="date" class="form-control @error('end_date') is-invalid @enderror"
                                id="end_date" name="end_date" value="{{ old('end_date', $data->end_date) }}">
                            @error('end_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6">
                            ...
                            <select class="form-select @error('event_type') is-invalid @enderror"
                                ...
                                <option value="holiday" {{ old('event_type', $data->event_type) === 'holiday' ? 'selected' : '' }}>Holiday</option>
                                <option value="exam" {{ old('event_type', $data->event_type) === 'exam' ? 'selected' : '' }}>Exam</option>
                                <option value="semester" {{ old('event_type', $data->event_type) === 'semester' ? 'selected' : '' }}>Semester</option>
                                <option value="event" {{ old('event_type', $data->event_type) === 'event' ? 'selected' : '' }}>Event</option>
                                <option value="other" {{ old('event_type', $data->event_type) === 'other' ? 'selected' : '' }}>Other</option>
                            </select>
                            @error('event_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="widget-content widget-content-area ecommerce-create-section">
                            <div class="row">
                                <div class="col-sm-12 mb-3">
                                    <button type="submit" class="btn btn-success w-100">Update Calendar</button>
                                </div>
                                <div class="col-sm-12">
