                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                name="name" value="{{ old('name', $data->name) }}" placeholder="Enter university name...">
                            @error('name')
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control @error('country') is-invalid @enderror" id="country"
                                name="country" value="{{ old('country', $data->country) }}" placeholder="Enter country...">
                            @error('country')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="widget-content widget-content-area ecommerce-create-section">
                            <div class="row">
                                <div class="col-sm-12 mb-3">
                                    <button type="submit" class="btn btn-success w-100">Update University</button>
                                </div>
                                <div class="col-sm-12">
