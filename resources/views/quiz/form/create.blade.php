                        ...
                        <div class="row mb-4">
                            <div class="col-sm-12">
                                ...
                                <div id="pre_test_notice_editor"
                                    ...
                                    data-placeholder="Contoh: tata tertib, syarat, atau pengumuman sebelum peserta mulai mengisi form">{!! old('pre_test_notice', '') !!}</div>
                                ...
                                <input type="hidden" id="pre_test_notice" name="pre_test_notice" value="{{ old('pre_test_notice') }}">
