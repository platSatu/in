...
@section('content')
    <div class="middle-content container-xxl p-0">
        ...
        <form action="{{ route('quiz.form.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="widget-content widget-content-area ecommerce-create-section">
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-12">
                                ...
                                @php
                                    $lockedCompanyBranchId = old('branch_id', $selectedCompanyBranchId ?? null);
                                    $lockedCompanyBranch = $lockedCompanyBranchId ? $companyBranches->firstWhere('id', $lockedCompanyBranchId) : null;
                                @endphp

                                @if ($lockedCompanyBranch && !$errors->has('branch_id'))
                                    <input type="text" class="form-control" value="{{ $lockedCompanyBranch->name }}" disabled readonly>
                                    <input type="hidden" name="branch_id" value="{{ $lockedCompanyBranch->id }}">
                                    <div class="form-text">
                                        Form ini akan dikaitkan ke company branch di atas.
                                        <a href="{{ route('quiz.form.create') }}">Ganti company branch</a>
                                    </div>
                                @else
                                    <select class="form-select @error('branch_id') is-invalid @enderror" id="branch_id" name="branch_id">
                                        <option value="">-- Select Company Branch --</option>
                                        @foreach ($companyBranches as $companyBranch)
                                            <option value="{{ $companyBranch->id }}" {{ $lockedCompanyBranchId == $companyBranch->id ? 'selected' : '' }}>
                                                {{ $companyBranch->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-12">
                                ...
                                <div class="form-text">Boleh angka maupun nama/kode booth.</div>
                                @error('no_booth')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="requires_payment"
                                        name="requires_payment" value="1" {{ old('requires_payment') ? 'checked' : '' }}>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="payment_position"
                                        ...
                                        {{ old('payment_position', 'before_questions') === 'before_questions' ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="payment_position"
                                        ...
                                        {{ old('payment_position') === 'after_questions' ? 'checked' : '' }}>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="is_callback_enabled"
                                        name="is_callback_enabled" value="1" {{ old('is_callback_enabled') ? 'checked' : '' }}>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="use_whatsapp_notification"
                                        name="use_whatsapp_notification" value="1" {{ old('use_whatsapp_notification') ? 'checked' : '' }}>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" id="has_personal_data_stage"
                                        name="has_personal_data_stage" value="1" {{ old('has_personal_data_stage') ? 'checked' : '' }}>
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-12">
                                ...
                                <textarea class="form-control @error('pre_test_notice') is-invalid @enderror" id="pre_test_notice" name="pre_test_notice"
                                    rows="6" placeholder="Contoh: tata tertib, syarat, atau pengumuman sebelum peserta mulai mengisi form">{{ old('pre_test_notice') }}</textarea>
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-6">
                                ...
                                <div class="form-text">Boleh dikosongkan — kalau tidak diupload, halaman quiz memakai background default.</div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="file" accept="image/*"
                                    ...
                                    id="logo" name="logo">
                                <div class="form-text">Boleh dikosongkan — kalau tidak diupload, halaman quiz memakai logo default. Favicon browser tidak ikut berubah.</div>
                                @error('logo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
