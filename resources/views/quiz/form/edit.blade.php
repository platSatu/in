                        ...
                        <div class="col-sm-12">
                            ...
                            <select class="form-select @error('company_division_id') is-invalid @enderror" id="company_division_id" name="company_division_id">
                                ...
                                @foreach ($companyDivisions as $companyDivision)
                                    <option value="{{ $companyDivision->id }}" {{ (string) old('company_division_id', $data->company_division_id) === (string) $companyDivision->id ? 'selected' : '' }}>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-8">
                            ...
                            <select class="form-select @error('result_mode') is-invalid @enderror" id="result_mode" name="result_mode">
                                ...
                                <option value="section_threshold" {{ old('result_mode', $data->result_mode) === 'section_threshold' ? 'selected' : '' }}>Section Threshold (gaya HSK)</option>
                            </select>
                            <div class="form-text">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="personal_data_stage_position"
                                    ...
                                    {{ old('personal_data_stage_position', $data->personal_data_stage_position ?? 'first') === 'first' ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="personal_data_stage_position"
                                    ...
                                    {{ old('personal_data_stage_position', $data->personal_data_stage_position ?? '') === 'last' ? 'checked' : '' }}>
                    ...
                    <div class="row mb-4" id="sectionThresholdSettingsWrapper">
                        <div class="col-sm-12">
                            <div class="form-text mb-2" style="color:#6c757d;">
                                ...
                                lihat menu "Form Sections"), bukan langsung di Section top-level. Peserta lolos dari
                                satu Section (lanjut ke Section berikutnya) atau berhenti di situ (jadi hasil akhir)
                                berdasarkan jumlah jawaban salah di Sub Section-Sub Section-nya.
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <input type="number" min="1" max="50"
                                ...
                                value="{{ old('section_fail_threshold', $data->section_fail_threshold) }}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="number" min="0" max="50"
                                ...
                                value="{{ old('section_pass_threshold', $data->section_pass_threshold) }}">
