                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6">
                            ...
                            <select id="type" name="type" class="form-select @error('type') is-invalid @enderror">
                                <option value="debit" {{ old('type', $data->type) === 'debit' ? 'selected' : '' }}>Debit</option>
                                <option value="credit" {{ old('type', $data->type) === 'credit' ? 'selected' : '' }}>Credit</option>
                            </select>
                            @error('type')
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-4">
                            ...
                            <input type="number" min="0" step="0.01"
                                   ...
                                   id="amount" name="amount" value="{{ old('amount', $data->amount) }}">
                            @error('amount')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-sm-4">
                            ...
                            <input type="number" min="0" step="0.01"
                                   ...
                                   id="balance_before" name="balance_before" value="{{ old('balance_before', $data->balance_before) }}">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="number" min="0" step="0.01"
                                   ...
                                   id="balance_after" name="balance_after" value="{{ old('balance_after', $data->balance_after) }}">
                            @error('balance_after')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6">
                            ...
                            <input type="text"
                                   ...
                                   id="reference_type" name="reference_type" value="{{ old('reference_type', $data->reference_type) }}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text"
                                   ...
                                   id="reference_id" name="reference_id" value="{{ old('reference_id', $data->reference_id) }}">
                            @error('reference_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-6">
                            ...
                            <input type="datetime-local"
                                   ...
                                   value="{{ old('transaction_date', optional($data->transaction_date)->format('Y-m-d\TH:i')) }}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <textarea id="description" name="description" rows="1"
                                      ...
                                      placeholder="Keterangan transaction...">{{ old('description', $data->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
