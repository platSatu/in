                ...
                <div class="table-responsive">
                    <table class="table dt-table-hover" style="width:100%">
                        ...
                        <tbody>
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink{{ $item->id }}">
                                                <a class="dropdown-item" href="{{ route('roleuser.edit', $item->id) }}">Edit</a>

                                                <form action="{{ route('roleuser.destroy', $item->id) }}"
                                                      method="POST"
                                                      onsubmit="return confirm('Hapus data role user ini?');">
                                                    @csrf
                                                    @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center">Belum ada data role user.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
