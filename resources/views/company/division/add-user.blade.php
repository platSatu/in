    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('company.division.show', $data->id) }}">{{ $data->name }}</a></li>
                <li class="breadcrumb-item active" aria-current="page">Add User</li>
            </ol>
        </nav>
    </div>

    <form action="{{ route('company.division.storeUser', $data->id) }}" method="POST">
        @csrf
        ...
        <div class="row mb-4 layout-spacing layout-top-spacing">
            ...
            <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="widget-content widget-content-area ecommerce-create-section">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12">
                            <label class="mb-2">Company Division</label>
                            <input type="text" class="form-control" value="{{ $data->name }}" disabled readonly>
                            <div class="form-text">User baru ini akan otomatis dimasukkan ke divisi di atas.</div>
                        </div>
                    </div>
                ...
                <div class="widget-content widget-content-area ecommerce-create-section">
                    <div class="row">
                        <div class="col-sm-12 mb-3">
                            <button type="submit" class="btn btn-success w-100">Create &amp; Add to Division</button>
                        </div>
                        <div class="col-sm-12">
                            <a href="{{ route('company.division.show', $data->id) }}" class="btn btn-outline-secondary w-100">Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
