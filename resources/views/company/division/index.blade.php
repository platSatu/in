                        ...
                        <tbody>
                            @forelse ($data as $index => $item)
                                <tr>
                                    ...
                                    <td>{{ optional($item->companyBranch)->name ?? '-' }}</td>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex flex-nowrap justify-content-center align-items-center gap-2">
                                            ...
                                            <form action="{{ route('company.division.destroy', $item->id) }}"
                                                method="POST" onsubmit="return confirm('Hapus company division ini?');" class="m-0">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="text-center">Belum ada data company division.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
