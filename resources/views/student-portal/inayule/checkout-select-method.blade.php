...
{{-- Khusus Duitku -- lihat docblock InaYulePackageCheckoutController::selectMethodForm(),
     pola & style sama persis dengan resources/views/dashboard/deposit/select-method.blade.php. --}}
...
<div class="col-lg-6 mx-auto layout-spacing">
    <div class="statbox widget box box-shadow">
        <div class="widget-content widget-content-area">
            ...
            <p class="text-muted">
                Sisa yang perlu dibayar via gateway: <strong>Rp {{ number_format((float) $payment->gateway_portion, 0, ',', '.') }}</strong>
            </p>
            ...
            @else
                <form method="POST" action="{{ route('inayule.checkout.select-method.store', ['orderId' => $payment->order_id]) }}">
                    @csrf
