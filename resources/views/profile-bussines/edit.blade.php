...
<div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
    <div class="widget-content widget-content-area ecommerce-create-section">
        <form method="POST" action="{{ route('profile-bussines.update', $data->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="row mb-4">
                <div class="col-sm-12">
                    ...
                    <div id="business-description" class="form-control @error('description') is-invalid @enderror" 
                         style="min-height: 150px;">{!! old('description', $data->description) !!}</div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <button type="submit" class="btn btn-success w-100">Update Business</button>
                </div>
            </div>
            ...
            <div class="widget-content widget-content-area ecommerce-create-section">
                <div class="row">
                    ...
                    <div class="col-sm-12 mb-4">
                        ...
                        <div class="switch form-switch-custom switch-inline form-switch-secondary">
                            ...
                            <label class="switch-label" for="status">
                                {{ old('status', $data->status) == 'active' ? 'Active' : 'Inactive' }}
                            </label>
                        </div>
                        @error('status')
                            <div class="text-danger mt-1">{{ $message }}</div>
                    ...
                    <div class="col-sm-12 mb-4">
                        ...
                        <p class="text-muted">{{ $data->created_at->format('d F Y, H:i') }}</p>
                    </div>

                    <!-- Tombol Kembali & Detail -->
                    <div class="col-sm-12">
                        <a href="{{ route('profile-bussines.show', $data->id) }}" class="btn btn-info w-100 mb-2">View Detail</a>
